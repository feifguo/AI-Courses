...
L6 特别注意：正式16课时默认不应在没有 M4 时连续安排“M2知识闯关→M2学习App”，避免表面产品重复。

## C. 仍待母版验证后完整教案化

- L3/L4：依赖 M3 互动故事/分支世界；
- L5：依赖 M4 兴趣馆/知识产品；
- L9/L10：依赖 M5 工作台/记录/校园工具。
...
> **25–30分钟左右锁定展示级 BASE；30–40分钟把试玩、判断、修改和收口做实；超过40分钟才进入额外 Challenge / Open Creation。**
