...
完整教师手册、完整学生手册、全量课程源文件、母版、Prompt、故障库属于课程方内部资产。

正式授课时，认证教师通过课程方 Teacher Portal 按学校、班级和课次查看当前需要的内容。

代理商长期持有的是销售、实施、培训组织和学校交付资料，不长期持有完整16课教师手册。
...
1. 先完成教师培训和认证；
2. 用个人教师账号进入 Teacher Portal；
3. 上哪一节课，就打开平台中的“本节教学页”；
4. 页面已经整合教案、投屏、学生任务和常见问题；
5. 不需要、也不会默认获得完整课程研发资料或完整学期教师手册。
